  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#121212] flex flex-col font-['Inter',sans-serif]">
      ...
      <div className="flex-1 p-4 flex flex-col gap-4 max-w-lg w-full mx-auto pb-8">
        ...
        {/* Email Support Card */}
        <a href="mailto:support@thebitecube.com" className="bg-white dark:bg-[#1a1a1a] rounded-[20px] p-6 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-[15px] text-[#2c3e50] dark:text-gray-400 font-medium mb-3">support@thebitecube.com</p>
