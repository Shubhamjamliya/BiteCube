...
export default function CategoryHeader({ stats = {}, onOpenAddModal }) {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Manage product categories, search, update status, and organize catalog items.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div>
            <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Total Categories</p>
