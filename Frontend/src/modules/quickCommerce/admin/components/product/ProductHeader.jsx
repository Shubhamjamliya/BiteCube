...
import { Plus, Package, CheckCircle2, XCircle, AlertCircle } from 'lucide-react';

export default function ProductHeader({ stats = {}, onOpenAddModal }) {
  return (
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Manage catalog items, pricing, inventory stock, categories, and subcategories.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-700">{stats.inactive || 0}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-rose-600">{stats.outOfStock || 0}</p>
          </div>
        </div>
      </div>
    </div>
