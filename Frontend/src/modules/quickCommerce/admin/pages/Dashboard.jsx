...
export default function Dashboard() {
  ...
  const totalFoods = dashboardData?.items?.total || 0
  const totalAddons = dashboardData?.categories?.total || 0
      ...
      <div className="relative overflow-hidden rounded-3xl border border-neutral-200 bg-white shadow-[0_30px_120px_-60px_rgba(0,0,0,0.28)]">
        ...
        <div className="flex flex-col gap-4 border-b border-neutral-200 bg-linear-to-br from-white via-neutral-50 to-neutral-100 px-6 py-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-neutral-500">Quick Commerce Overview</p>
        ...
        <div className="space-y-6 px-6 py-6">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <MetricCard
              ...
              helper={`${periodLabel} store cut`}
              icon={<ArrowUpRight className="h-5 w-5 text-indigo-600" />}
              accent="bg-indigo-200/40"
              path="/admin/quick-commerce/stores/commission"
            />
            <MetricCard
            ...
            <MetricCard
              ...
              accent="bg-blue-200/40"
              path="/admin/quick-commerce/stores"
            />
            <MetricCard
              ...
              accent="bg-orange-200/40"
              path="/admin/quick-commerce/stores/joining-request"
            />
            <MetricCard
              ...
              accent="bg-indigo-200/40"
              path="/admin/quick-commerce/delivery"
            />
            <MetricCard
              ...
              path="/admin/quick-commerce/delivery/join-request"
            />
            <MetricCard
              title="Total items"
              value={totalFoods.toLocaleString("en-IN")}
              helper="Approved inventory items"
              icon={<Package className="h-5 w-5 text-purple-600" />}
              accent="bg-purple-200/40"
              path="/admin/quick-commerce/inventory"
            />
            <MetricCard
              title="Total categories"
              value={totalAddons.toLocaleString("en-IN")}
              helper="Approved categories"
            ...
            <MetricCard
              ...
              path="/admin/quick-commerce/orders/pending"
            />
            <MetricCard
              ...
              accent="bg-emerald-200/40"
              path="/admin/quick-commerce/orders/delivered"
            />
          </div>
