...
const orderSchema = new mongoose.Schema(
    ...
    {
        collection: 'quick_commerce_orders',
        timestamps: true
    }
);
...
orderSchema.pre('save', async function (next) {
    if (!this.order_id) {
        ...
        this.order_id = `QC-${timestamp}${random}`;
    }
...
export const QuickCommerceOrder = mongoose.model('QuickCommerceOrder', orderSchema);
...
const settingsSchema = new mongoose.Schema(
    ...
    { collection: 'quick_commerce_order_settings', timestamps: true }
);

export const QuickCommerceOrderSettings = mongoose.model('QuickCommerceOrderSettings', settingsSchema);
