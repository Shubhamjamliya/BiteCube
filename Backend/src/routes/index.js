...
router.get('/v1/quick-commerce/hero-banners/public', getPublicQuickHeroBannersController);
router.get('/v1/food/hero-banners/quick/public', getPublicQuickHeroBannersController);
